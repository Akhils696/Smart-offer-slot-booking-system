...
public partial class InitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(name: "IX_bookings_OfferSlotId", table: "bookings", column: "OfferSlotId");
        migrationBuilder.CreateIndex(name: "IX_bookings_ReferenceCode", table: "bookings", column: "ReferenceCode", unique: true);
        migrationBuilder.CreateIndex(name: "IX_bookings_UserId_OfferSlotId", table: "bookings", columns: new[] { "UserId", "OfferSlotId" });
        migrationBuilder.CreateIndex(name: "IX_businesses_OwnerId", table: "businesses", column: "OwnerId");
        migrationBuilder.CreateIndex(name: "IX_businesses_Slug", table: "businesses", column: "Slug", unique: true);
        migrationBuilder.CreateIndex(name: "IX_offer_slots_OfferId_StartsAt", table: "offer_slots", columns: new[] { "OfferId", "StartsAt" });
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropTable(name: "offer_slots");
